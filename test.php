...
$status="pending";
$invoice_no=mt_rand();
$select_cart="select * form cart where ip_add='$ip_add'";
...
while ($row_cart=mysqli_fetch_array($run_cart)) {
	...
	while ($row_pro=mysqli_fetch_array($run_pro)) {
		...
		(customer_id,due_amount,invoice_no,qty,size,order_date,order_status) values('$customer_id','$sub_total','$invoice_no','$qty','$size',NOW(),'$status',)
		";
